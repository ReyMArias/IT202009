...
if (isset($_POST["search"]) && !empty($query)) {
    $db = getDB();
    $stmt = $db->prepare("SELECT PointsHistory.id,points_change, user_id, Users.username FROM PointsHistory JOIN Users on PointsHistory.user_id = Users.id WHERE Users.username like :q");
