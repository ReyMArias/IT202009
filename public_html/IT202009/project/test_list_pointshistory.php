...
if (isset($_POST["search"]) && !empty($query)) {
    $db = getDB();
    $stmt = $db->prepare("SELECT PointsHistory.id,points_change,reason, user_id, Users.username, Scores.score FROM PointsHistory JOIN Users on PointsHistory.user_id = Users.id LEFT JOIN Scores on PointHistory.user_id = Scores.id WHERE Users.username like :q");
